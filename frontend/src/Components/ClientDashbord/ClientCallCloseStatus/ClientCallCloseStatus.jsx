...
import "./ClientCallCloseStatus.css";

const ClientCallCloseStatus = () => {
              ...
              <table className="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Call Complete</th>
                    <th scope="col">Call Close</th>
                  </tr>
                </thead>
                <tbody>
...
export default ClientCallCloseStatus;